...
export default {
  ...
  methods: {
    // 创建小心心
    createLoves(event,a,b) {//这个地方 a,b代表定位文字和小心心
      let x = 0;
      let y = 0;
    ...
    removeSmallHert(){
      // console.log(this.loves[this.count-1])
...
/* biubiubiu小心心 start */
.img {width: 20px;height: 00px;opacity: 1;position: absolute;z-index: 1000;transition: 2.5s;float: left;}
...
.text {width: 50px;font-size: 20px;line-height: 1;position: absolute;top: -1em;left: -15px;text-align: center;}
